...
class RidesControllerTest < ActionController::TestCase
  ...
  test "should update ride" do
    patch :update, id: @ride, ride: { direction: @ride.direction, freeSeats: @ride.freeSeats, fromAddress: @ride.fromAddress, fromCity: @ride.fromCity, ride_id: @ride.ride_id, status: @ride.status, time: @ride.time, toAddress: @ride.toAddress, toCity: @ride.toCity, type: @ride.type, user_id: @ride.user_id }
    assert_redirected_to ride_path(assigns(:ride))
  end
